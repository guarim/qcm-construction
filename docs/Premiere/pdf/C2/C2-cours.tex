...
\begin{frame}
	...
	\begin{block}{Convention d'écriture}
		\begin{itemize}
			...
			\item<4-> Afin d'éviter toute confusion, on convient d'écrire  en indice la base dans lequel le nombre est écrit
...
\begin{frame}
	...
	\begin{block}{Vocabulaire}
		\begin{itemize}
			...
			\item<2-> Le regroupement de 8 bits s'appelle un \textcolor{red}{octet} (en anglais un $byte$).
