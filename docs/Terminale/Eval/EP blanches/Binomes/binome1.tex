...
Ecrire une fonction {\tt envers} qui prend en argument une liste et renvoie cette liste à l'envers, c'est à dire de son premier élément à son dernier élément.\\
