...
Ecrire une fonction {\tt est\_triee} qui prend en argument une liste d'entiers \textit{non vide} {\tt entiers} et renvoie {\tt True} si cette liste est triée par ordre croissant ou décroissant et {\tt False} sinon.


\textbf{Exemples :}
\begin{lstlisting}
>>> est_triee([12, 11, 8, 20, 15])
False
>>> est_triee([-5, -1, 0, 4, 4, 7])
True
>>> est_triee([19, 11, 2, -10])
True
\end{lstlisting}
