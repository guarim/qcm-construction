...
\FinListe
\item En mathématiques, la factorielle d'un entier naturelle $n$ est le produit des nombres entiers strictement positifs inférieurs ou égaux à $n$. Par convention, la factorielle de 0 est 1. Par exemple :
\begin{itemize}
...
Pile &  \  \newline 
 ...
 \\ 
 \hline
 Valeurs renvoyées &  & \dots & \dots & \dots \\
 \hline 
\end{tabularx}
