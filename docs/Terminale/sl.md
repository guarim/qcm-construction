...
1. {{exo_du_bac("21-NSIJ1AN1","5")}}
2. {{exo_du_bac("21-NSIJ1ME2","2")}}
3. {{exo_du_bac("21-NSIJ2ME1","5")}}


{{ exo("Exercices extraits de sujet de bac 2022",["bac"]) }}

1. {{exo_du_bac("22-NSIJ1G11","2")}}
2. {{exo_du_bac("22-NSIJ1LR1","1")}}
3. {{exo_du_bac("22-NSIJ1ME1","1")}}
4. {{exo_du_bac("22-NSIJ1PO1","4")}}
5. {{exo_du_bac("22-NSIJ2ME1","2")}}
