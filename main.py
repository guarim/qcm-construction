...
|-|-------------|-------|
    ...
    def enonce_ep(annee,numero):
        ...
        return f"<span class='centre'>[Sujet {numero} - {annee} :material-download:](https://fabricenativel.github.io/officiels/Annales/EP/{annee}/{code}/{code}.pdf)"+"{.md-button}</span>"
...
!!! fabquestion "**{index}.** {lenonce}
    ...
    @env.macro
    def code_insert(niveau,chap,nom,ntab=0):
        stab = '\t'*ntab
        modele = f'''
